...
class EmployeesFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => '', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'email_address' => ['type' => 'string', 'length' => 40, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => '41faf8ca-818b-4543-a926-f1cb9bed5c3e',
